...
The `path` fields are the original corpus-relative locations. The corresponding PDF binaries were not present in the recovered paper artifact and are not included here.
